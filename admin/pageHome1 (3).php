...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title>LDTCS GMT Fleet Maintenance | <?php echo $Translation['admin area']; ?><?php echo html_attr(isset($GLOBALS['page_title']) ? " | {$GLOBALS['page_title']}" : ''); ?></title>
 
		<link id="browser_favicon" rel="shortcut icon" href="<?php echo PREPEND_PATH; ?>images/box-config-icon.png">

		<link rel="stylesheet" href="<?php echo PREPEND_PATH; ?>resources/initializr/css/papers.css">
	...
	<div class="container theme-bootstrap theme-3d">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="pageHome.php"><span class="text-primary"><img src="images/box-config-icon.png" /><b style="color: #C3C3C3"> ADMIN AREA</b></a>
			</div>

			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="images/groups.png" /> <?php echo $Translation['groups']; ?> <b class="caret"></b></a>
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="images/civil_engineer_128.png" /> <?php echo $Translation['members']  ;?> <b class="caret"></b></a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="images/applications-engineering1.png" /> <?php echo $Translation['utilities']; ?> <b class="caret"></b></a>
						<ul class="dropdown-menu">
					...
					<?php } ?>
				</ul><img src="images/logo.png" width="188" height="75" border="0" alt="logo" />

				<div class="navbar-right">
				<a class="navbar-brand" href="auditLog.php"><span class="text-warning-1"><img src="images/auditor.png" /><b style="color: #C3C3C3"> AUDIT</b></span></a>
					<a href="<?php echo PREPEND_PATH; ?>index.php" class="btn btn-success navbar-btn"><img src="images/administrator.png"  /><b style="color: #C3C3C3"> USER AREA</b></a>
					<a href="<?php echo PREPEND_PATH; ?>index.php?signOut=1" class="btn btn-warning navbar-btn"><img src="images/wheel.png" /> <?php echo $Translation["sign out"] ; ?></a>
				</div>
			</div>
		</nav>
		<script>
