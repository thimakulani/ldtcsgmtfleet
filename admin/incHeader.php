...
background-size: cover;
	...
	<body>
	<div class="admin-area container theme-bootstrap">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="pageHome.php"><span class="text-primary"><img src="images/box-config-icon.png" /><b style="color: #C3C3C3"> ADMIN</b></a>
			</div>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					...
					<?php if(count($plugins)){ ?>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="images/plugins.png" /> <?php echo $Translation["plugins"] ; ?> <b class="caret"></b></a>
							<ul class="dropdown-menu">
				...
				<div class="navbar-right">
					...
					<a href="<?php echo PREPEND_PATH; ?>admin/auditLog.php" class="btn btn-danger navbar-btn"><img src="images/auditor.png" /><b style="color: #C3C3C3"> AUDIT</b></span></a>
