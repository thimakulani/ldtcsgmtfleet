...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$table_perms = getTablePermissions('internal_repairs_body');
	...
	switch($mfk) {
		...
		case 'driver_name_and_surname':
			if(!$id) {
				...
				$j('#driver_license_code<?php echo $rnd1; ?>').html('&nbsp;');
				$j('#driver_license_number<?php echo $rnd1; ?>').html('&nbsp;');
				<?php
				break;
			}
			...
			$j('#driver_license_code<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['drivers_license_code']))); ?>&nbsp;');
			$j('#driver_license_number<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['drivers_license_number']))); ?>&nbsp;');
			<?php
			break;
