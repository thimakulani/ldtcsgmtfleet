...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$table_perms = getTablePermissions('vehicle_annual_inspection');
	...
	switch($mfk) {
		...
		case 'vehicle_registration_number':
			if(!$id) {
				...
				$j('#year_model_specification<?php echo $rnd1; ?>').html('&nbsp;');
				$j('#engine_capacity<?php echo $rnd1; ?>').html('&nbsp;');
				$j('#tyre_size<?php echo $rnd1; ?>').html('&nbsp;');
				$j('#transmission<?php echo $rnd1; ?>').html('&nbsp;');
				$j('#fuel_type<?php echo $rnd1; ?>').html('&nbsp;');
				$j('#type_of_vehicle<?php echo $rnd1; ?>').html('&nbsp;');
				$j('#colour_of_vehicle<?php echo $rnd1; ?>').html('&nbsp;');
			...
			$j('#year_model_specification<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['year_model_specification']))); ?>&nbsp;');
			$j('#engine_capacity<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['engine_capacity']))); ?>&nbsp;');
			$j('#tyre_size<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['tyre_size']))); ?>&nbsp;');
			$j('#transmission<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['transmission']))); ?>&nbsp;');
			$j('#fuel_type<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['fuel_type']))); ?>&nbsp;');
			$j('#type_of_vehicle<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['type_of_vehicle']))); ?>&nbsp;');
			$j('#colour_of_vehicle<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['colour_of_vehicle']))); ?>&nbsp;');
