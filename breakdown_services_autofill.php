...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$table_perms = getTablePermissions('breakdown_services');
	...
	switch($mfk) {
		...
		case 'description_of_vehicle_breakdown_notes':
			if(!$id) {
				?>
				$j('#receptionist<?php echo $rnd1; ?>').html('&nbsp;');
			...
			?>
			$j('#receptionist<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['reception_name_and_surname']))); ?>&nbsp;');
