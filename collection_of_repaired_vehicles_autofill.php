...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$table_perms = getTablePermissions('collection_of_repaired_vehicles');
	...
	switch($mfk) {
		...
		case 'reception_name_and_surname':
			if(!$id) {
				?>
				$j('#reception_persal_number<?php echo $rnd1; ?>').html('&nbsp;');
				$j('#reception_contact_details<?php echo $rnd1; ?>').html('&nbsp;');
				$j('#reception_email_address<?php echo $rnd1; ?>').html('&nbsp;');
				<?php
				break;
			}
			...
			?>
			$j('#reception_persal_number<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['reception_persal_number']))); ?>&nbsp;');
			$j('#reception_contact_details<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['reception_contact_details']))); ?>&nbsp;');
			$j('#reception_email_address<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['reception_email_address']))); ?>&nbsp;');
			<?php
			break;
		...
		case 'driver_name_and_surname':
			if(!$id) {
				...
				$j('#driver_contacts_details<?php echo $rnd1; ?>').html('&nbsp;');
				$j('#driver_email_address<?php echo $rnd1; ?>').html('&nbsp;');
				<?php
				break;
			}
			...
			$j('#driver_contacts_details<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['drivers_contact_details']))); ?>&nbsp;');
			$j('#driver_email_address<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['drivers_email_address']))); ?>&nbsp;');
			<?php
			break;
