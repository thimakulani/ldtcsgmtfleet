<?php
	...
	$current_table = 'vehicle_handing_over_checklist';
			...
			<table data-tablename="<?php echo $current_table; ?>" class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr data-id="<?php echo html_attr($pkValue); ?>">
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][8]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][8]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="mailto:<?php echo html_attr($record[8]); ?>" class="btn btn-info" title="<?php echo html_attr($record[8]); ?>"><i class="glyphicon glyphicon-envelope"></i></a></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][41]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][41]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="thumbnail.php?i=<?php echo $record[41]; ?>&t=vehicle_handing_over_checklist&f=driver_signature&v=tv" class="img-thumbnail"></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][44]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][44]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="thumbnail.php?i=<?php echo $record[44]; ?>&t=vehicle_handing_over_checklist&f=testing_officer_signature&v=tv" class="img-thumbnail"></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][46]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][46]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[46]); ?>" data-lightbox="vehicle_handing_over_checklist-vehicle_marks_1"><img src="thumbnail.php?i=<?php echo urlencode($record[46]); ?>&t=vehicle_handing_over_checklist&f=vehicle_marks_1&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][47]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][47]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[47]); ?>" data-lightbox="vehicle_handing_over_checklist-vehicle_marks_2"><img src="thumbnail.php?i=<?php echo urlencode($record[47]); ?>&t=vehicle_handing_over_checklist&f=vehicle_marks_2&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][48]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][48]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[48]); ?>" data-lightbox="vehicle_handing_over_checklist-vehicle_marks_3"><img src="thumbnail.php?i=<?php echo urlencode($record[48]); ?>&t=vehicle_handing_over_checklist&f=vehicle_marks_3&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][49]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][49]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[49]); ?>" data-lightbox="vehicle_handing_over_checklist-vehicle_marks_4"><img src="thumbnail.php?i=<?php echo urlencode($record[49]); ?>&t=vehicle_handing_over_checklist&f=vehicle_marks_4&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][50]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][50]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[50]); ?>" data-lightbox="vehicle_handing_over_checklist-vehicle_marks_5"><img src="thumbnail.php?i=<?php echo urlencode($record[50]); ?>&t=vehicle_handing_over_checklist&f=vehicle_marks_5&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][51]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][51]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[51]); ?>" data-lightbox="vehicle_handing_over_checklist-vehicle_marks_6"><img src="thumbnail.php?i=<?php echo urlencode($record[51]); ?>&t=vehicle_handing_over_checklist&f=vehicle_marks_6&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][52]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][52]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[52]); ?>" data-lightbox="vehicle_handing_over_checklist-vehicle_marks_7"><img src="thumbnail.php?i=<?php echo urlencode($record[52]); ?>&t=vehicle_handing_over_checklist&f=vehicle_marks_7&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][53]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][53]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[53]); ?>" data-lightbox="vehicle_handing_over_checklist-vehicle_marks_8"><img src="thumbnail.php?i=<?php echo urlencode($record[53]); ?>&t=vehicle_handing_over_checklist&f=vehicle_marks_8&v=tv" class="img-thumbnail"></a></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][55]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][55]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><?php if($record[55]) { ?><a href="link.php?t=<?php echo $parameters['ChildTable']; ?>&f=vehicle_handing_over_ckecklist&i=<?php echo urlencode($record[$config['child-primary-key-index']]); ?>" target="_blank" class="btn btn-default" title="<?php echo html_attr($record[55]); ?>"><i class="glyphicon glyphicon-lg glyphicon-file text-info"></i></a><?php } ?></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
