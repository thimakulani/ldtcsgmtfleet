<?php
	...
	$current_table = 'vehicle_return_check_list';
			...
			<table data-tablename="<?php echo $current_table; ?>" class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr data-id="<?php echo html_attr($pkValue); ?>">
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][33]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][33]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="thumbnail.php?i=<?php echo $record[33]; ?>&t=vehicle_return_check_list&f=driver_signature&v=tv" class="img-thumbnail"></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][36]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][36]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="thumbnail.php?i=<?php echo $record[36]; ?>&t=vehicle_return_check_list&f=testing_officer_signature&v=tv" class="img-thumbnail"></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][37]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][37]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[37]); ?>" data-lightbox="vehicle_return_check_list-vehicle_marks_1"><img src="thumbnail.php?i=<?php echo urlencode($record[37]); ?>&t=vehicle_return_check_list&f=vehicle_marks_1&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][38]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][38]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[38]); ?>" data-lightbox="vehicle_return_check_list-vehicle_marks_2"><img src="thumbnail.php?i=<?php echo urlencode($record[38]); ?>&t=vehicle_return_check_list&f=vehicle_marks_2&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][39]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][39]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[39]); ?>" data-lightbox="vehicle_return_check_list-vehicle_marks_3"><img src="thumbnail.php?i=<?php echo urlencode($record[39]); ?>&t=vehicle_return_check_list&f=vehicle_marks_3&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][40]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][40]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[40]); ?>" data-lightbox="vehicle_return_check_list-vehicle_marks_4"><img src="thumbnail.php?i=<?php echo urlencode($record[40]); ?>&t=vehicle_return_check_list&f=vehicle_marks_4&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][41]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][41]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[41]); ?>" data-lightbox="vehicle_return_check_list-vehicle_marks_5"><img src="thumbnail.php?i=<?php echo urlencode($record[41]); ?>&t=vehicle_return_check_list&f=vehicle_marks_5&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][42]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][42]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[42]); ?>" data-lightbox="vehicle_return_check_list-vehicle_marks_6"><img src="thumbnail.php?i=<?php echo urlencode($record[42]); ?>&t=vehicle_return_check_list&f=vehicle_marks_6&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][43]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][43]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[43]); ?>" data-lightbox="vehicle_return_check_list-vehicle_marks_7"><img src="thumbnail.php?i=<?php echo urlencode($record[43]); ?>&t=vehicle_return_check_list&f=vehicle_marks_7&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][44]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][44]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[44]); ?>" data-lightbox="vehicle_return_check_list-vehicle_marks_8"><img src="thumbnail.php?i=<?php echo urlencode($record[44]); ?>&t=vehicle_return_check_list&f=vehicle_marks_8&v=tv" class="img-thumbnail"></a></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][46]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][46]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><?php if($record[46]) { ?><a href="link.php?t=<?php echo $parameters['ChildTable']; ?>&f=vehicle_return_list&i=<?php echo urlencode($record[$config['child-primary-key-index']]); ?>" target="_blank" class="btn btn-default" title="<?php echo html_attr($record[46]); ?>"><i class="glyphicon glyphicon-lg glyphicon-file text-info"></i></a><?php } ?></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
