<?php
	...
	$current_table = 'identification_of_defects';
			...
			<table data-tablename="<?php echo $current_table; ?>" class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr data-id="<?php echo html_attr($pkValue); ?>">
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][7]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][7]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="mailto:<?php echo html_attr($record[7]); ?>" class="btn btn-info" title="<?php echo html_attr($record[7]); ?>"><i class="glyphicon glyphicon-envelope"></i></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][8]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][8]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="thumbnail.php?i=<?php echo $record[8]; ?>&t=identification_of_defects&f=end_user_signature&v=tv" class="img-thumbnail"></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][15]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][15]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="thumbnail.php?i=<?php echo $record[15]; ?>&t=identification_of_defects&f=transport_officer_email_address&v=tv" class="img-thumbnail"></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][19]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][19]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="mailto:<?php echo html_attr($record[19]); ?>" class="btn btn-info" title="<?php echo html_attr($record[19]); ?>"><i class="glyphicon glyphicon-envelope"></i></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][20]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][20]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="thumbnail.php?i=<?php echo $record[20]; ?>&t=identification_of_defects&f=government_garage_manager_signature&v=tv" class="img-thumbnail"></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
