<?php
	...
	$current_table = 'modification_to_vehicle';
			...
			<table data-tablename="<?php echo $current_table; ?>" class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr data-id="<?php echo html_attr($pkValue); ?>">
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][10]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][10]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="thumbnail.php?i=<?php echo $record[10]; ?>&t=modification_to_vehicle&f=driver_signature&v=tv" class="img-thumbnail"></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][47]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][47]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="thumbnail.php?i=<?php echo $record[47]; ?>&t=modification_to_vehicle&f=testing_officer_signature&v=tv" class="img-thumbnail"></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][52]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][52]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="thumbnail.php?i=<?php echo $record[52]; ?>&t=modification_to_vehicle&f=supervisor_for_allocation_signature&v=tv" class="img-thumbnail"></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
