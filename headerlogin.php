...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title><?php echo ucwords('LDTCS GMT Fleet Maintenance'); ?> | <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
	...
	<body>
		<div class="users-area container container theme-cyborg">
...
<p align="center"><img src="images/logo.png" width="315" height="122" border="0" alt="logo" /></p>