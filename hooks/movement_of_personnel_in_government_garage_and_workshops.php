<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'movement_of_personnel_in_government_garage_and_workshops' table. 
	...
	*/
	...
	function movement_of_personnel_in_government_garage_and_workshops_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function movement_of_personnel_in_government_garage_and_workshops_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function movement_of_personnel_in_government_garage_and_workshops_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['vehicle_inspection'], $data['vehicle_model'], $data['vehicle_number_plate'], $data['vehicle_tires_check'], $data['vehicle_mirrow_check'], $data['gate_security_signature'], $data['government_garage_protocol'], $data['government_garage_safety'], $data['vehicle_handing_over_checklist'], $data['vehicle_return_list'], $data['approved_workshop_procedure_manual'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle']
	...
	*/
	...
	function movement_of_personnel_in_government_garage_and_workshops_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function movement_of_personnel_in_government_garage_and_workshops_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function movement_of_personnel_in_government_garage_and_workshops_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function movement_of_personnel_in_government_garage_and_workshops_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function movement_of_personnel_in_government_garage_and_workshops_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function movement_of_personnel_in_government_garage_and_workshops_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function movement_of_personnel_in_government_garage_and_workshops_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function movement_of_personnel_in_government_garage_and_workshops_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function movement_of_personnel_in_government_garage_and_workshops_batch_actions(&$args) {
