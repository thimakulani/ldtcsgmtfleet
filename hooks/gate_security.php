<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'gate_security' table. 
	...
	*/
	...
	function gate_security_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function gate_security_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function gate_security_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['gate_security_name_and_surname'], $data['gate_security_contact_details'], $data['gate_security_signature'], $data['date_of_vehicle_entrance'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['vehicle_colour'], $data['vehicle_inspection'], $data['vehicle_tires_size'], $data['vehicle_tires_check'], $data['vehicle_mirrow_check'], $data['vehicle_interiour_condition'], $data['vehicle_exteriour_condition'], $data['gate_security_company_name'], $data['gate_security_company_contact_details'], $data['gate_security_manager_name_and_surname'], $data['gate_security_manager_contact_details'], $data['gate_security_company_address'], $data['inspection_of_vehicle_report'], $data['record_of_vehicle'], $data['date_of_vehicle_exit']
	...
	*/
	...
	function gate_security_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function gate_security_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['gate_security_user_id'], $data['gate_security_name_and_surname'], $data['gate_security_contact_details'], $data['gate_security_signature'], $data['date_of_vehicle_entrance'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['vehicle_colour'], $data['vehicle_inspection'], $data['vehicle_tires_size'], $data['vehicle_tires_check'], $data['vehicle_mirrow_check'], $data['vehicle_interiour_condition'], $data['vehicle_exteriour_condition'], $data['gate_security_company_name'], $data['gate_security_company_contact_details'], $data['gate_security_manager_name_and_surname'], $data['gate_security_manager_contact_details'], $data['gate_security_company_address'], $data['inspection_of_vehicle_report'], $data['record_of_vehicle'], $data['date_of_vehicle_exit']
	...
	*/
	...
	function gate_security_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function gate_security_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function gate_security_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function gate_security_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function gate_security_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function gate_security_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function gate_security_batch_actions(&$args) {
