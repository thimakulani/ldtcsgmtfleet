<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'service_type' table. 
	...
	*/
	...
	function service_type_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function service_type_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function service_type_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['service'], $data['type_of_service'], $data['reference'], $data['service_item_type'], $data['service_category'], $data['service_item'], $data['frequency_time_number'], $data['frequency_time'], $data['frequency_odometer']
	...
	*/
	...
	function service_type_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function service_type_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['service_type_id'], $data['service'], $data['type_of_service'], $data['reference'], $data['service_item_type'], $data['service_category'], $data['service_item'], $data['frequency_time_number'], $data['frequency_time'], $data['frequency_odometer']
	...
	*/
	...
	function service_type_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function service_type_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function service_type_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function service_type_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function service_type_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function service_type_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function service_type_batch_actions(&$args) {
