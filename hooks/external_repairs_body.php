<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'external_repairs_body' table. 
	...
	*/
	...
	function external_repairs_body_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_body_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function external_repairs_body_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['head_panel_beating_name'], $data['head_panel_beating_contact_details'], $data['head_panel_beating_address'], $data['head_panel_beating_signature'], $data['panel_beating_quotation'], $data['panel_beating_quotation_approved_by_service_provider'], $data['service_provider_name'], $data['service_provider_type'], $data['service_provider_contact_details'], $data['service_provider_address'], $data['service_provider_branch'], $data['service_provider_branch_code'], $data['service_provider_signature'], $data['instruction_note'], $data['authorization_number'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['vehicle_colour'], $data['vehicle_inspection_done'], $data['vehicle_inspection_check_list_form'], $data['vehicle_tyre_sizes'], $data['vehicle_mirrow_check'], $data['vehicle_interior_condition'], $data['vehicle_exterior_condition'], $data['merchant_type'], $data['merchant_code'], $data['merchant_name'], $data['merchant_contacts_details'], $data['merchant_email_address'], $data['merchant_signature'], $data['merchant_address'], $data['merchant_address_code'], $data['merchant_city'], $data['head_panel_beating_monitor_progress'], $data['head_panel_beating_monitor_quality_of_work_manship'], $data['vehicle_inspection_report'], $data['upload_invoice']
	...
	*/
	...
	function external_repairs_body_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_body_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_body_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_body_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_body_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_body_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_body_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function external_repairs_body_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_body_batch_actions(&$args) {
