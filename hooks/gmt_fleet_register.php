<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'gmt_fleet_register_2022' table. 
	...
	*/
	...
	function gmt_fleet_register_2022_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function gmt_fleet_register_2022_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function gmt_fleet_register_2022_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function gmt_fleet_register_2022_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function gmt_fleet_register_2022_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function gmt_fleet_register_2022_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function gmt_fleet_register_2022_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function gmt_fleet_register_2022_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function gmt_fleet_register_2022_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function gmt_fleet_register_2022_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function gmt_fleet_register_2022_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function gmt_fleet_register_2022_batch_actions(&$args) {
