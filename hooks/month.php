<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'month' table. 
	...
	*/
	...
	function month_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function month_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function month_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function month_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function month_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function month_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function month_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function month_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function month_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function month_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function month_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function month_batch_actions(&$args) {
