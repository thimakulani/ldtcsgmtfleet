<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'fuel_type' table. 
	...
	*/
	...
	function fuel_type_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function fuel_type_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function fuel_type_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function fuel_type_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function fuel_type_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function fuel_type_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function fuel_type_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function fuel_type_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function fuel_type_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function fuel_type_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function fuel_type_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function fuel_type_batch_actions(&$args) {
