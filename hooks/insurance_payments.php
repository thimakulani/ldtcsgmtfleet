<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'insurance_payments' table. 
	...
	*/
	...
	function insurance_payments_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function insurance_payments_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function insurance_payments_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['vehicle_registration_number'], $data['engine_number'], $data['chassis_number'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['year_model_of_vehicle'], $data['type_of_vehicle'], $data['application_status'], $data['barcode_number'], $data['department'], $data['insurance_reference'], $data['insurance_expiration'], $data['transaction_date'], $data['reference_number'], $data['merchant_name'], $data['payment_amount'], $data['month_end'], $data['documents'], $data['comments']
	...
	*/
	...
	function insurance_payments_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function insurance_payments_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['insurance_payment_id'], $data['vehicle_registration_number'], $data['engine_number'], $data['chassis_number'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['year_model_of_vehicle'], $data['type_of_vehicle'], $data['application_status'], $data['barcode_number'], $data['department'], $data['insurance_reference'], $data['insurance_expiration'], $data['transaction_date'], $data['reference_number'], $data['merchant_name'], $data['payment_amount'], $data['month_end'], $data['documents'], $data['comments']
	...
	*/
	...
	function insurance_payments_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function insurance_payments_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function insurance_payments_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function insurance_payments_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function insurance_payments_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function insurance_payments_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function insurance_payments_batch_actions(&$args) {
