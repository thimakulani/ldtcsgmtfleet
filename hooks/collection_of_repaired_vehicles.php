<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'collection_of_repaired_vehicles' table. 
	...
	*/
	...
	function collection_of_repaired_vehicles_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function collection_of_repaired_vehicles_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function collection_of_repaired_vehicles_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['reception_name_and_surname'], $data['reception_persal_number'], $data['reception_contact_details'], $data['reception_email_address'], $data['reception_signature'], $data['driver_name_and_surname'], $data['driver_persal_number'], $data['driver_contacts_details'], $data['driver_email_address'], $data['driver_license_upload'], $data['driver_signature'], $data['government_garage_name'], $data['government_garage_contact_details'], $data['government_garage_address'], $data['government_garage_email_address'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['vehicle_inspection'], $data['vehicle_inspection_form'], $data['vehicle_interiour_condition'], $data['vehicle_exteriour_condition'], $data['vehicle_tyre_check'], $data['sign_off_time'], $data['date_of_repaired_vehicle_collection']
	...
	*/
	...
	function collection_of_repaired_vehicles_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function collection_of_repaired_vehicles_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function collection_of_repaired_vehicles_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function collection_of_repaired_vehicles_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function collection_of_repaired_vehicles_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function collection_of_repaired_vehicles_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function collection_of_repaired_vehicles_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function collection_of_repaired_vehicles_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function collection_of_repaired_vehicles_batch_actions(&$args) {
