<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'accident_type' table. 
	...
	*/
	...
	function accident_type_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function accident_type_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function accident_type_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function accident_type_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function accident_type_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['accident_type_id'], $data['accident_type']
	...
	*/
	...
	function accident_type_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function accident_type_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function accident_type_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function accident_type_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function accident_type_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function accident_type_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function accident_type_batch_actions(&$args) {
