<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'service_provider' table. 
	...
	*/
	...
	function service_provider_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function service_provider_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function service_provider_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['service_provider_type'], $data['service_provider_name'], $data['service_provider_contact_email'], $data['service_provider_contact_details'], $data['service_provider_street_address'], $data['service_provider_branch_code'], $data['service_provider_branch'], $data['service_provider_city'], $data['service_provider_address_code']
	...
	*/
	...
	function service_provider_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function service_provider_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['service_provider_id'], $data['service_provider_type'], $data['service_provider_name'], $data['service_provider_contact_email'], $data['service_provider_contact_details'], $data['service_provider_street_address'], $data['service_provider_branch_code'], $data['service_provider_branch'], $data['service_provider_city'], $data['service_provider_address_code']
	...
	*/
	...
	function service_provider_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function service_provider_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function service_provider_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function service_provider_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function service_provider_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function service_provider_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function service_provider_batch_actions(&$args) {
