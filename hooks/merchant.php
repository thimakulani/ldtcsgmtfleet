<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'merchant' table. 
	...
	*/
	...
	function merchant_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function merchant_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function merchant_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['merchant_type'], $data['merchant_code'], $data['merchant_name'], $data['merchant_contact_email'], $data['merchant_street_address'], $data['merchant_suburb'], $data['merchant_city'], $data['merchant_address_code'], $data['merchant_contact_details']
	...
	*/
	...
	function merchant_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function merchant_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['merchant_id'], $data['merchant_type'], $data['merchant_code'], $data['merchant_name'], $data['merchant_contact_email'], $data['merchant_street_address'], $data['merchant_suburb'], $data['merchant_city'], $data['merchant_address_code'], $data['merchant_contact_details']
	...
	*/
	...
	function merchant_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function merchant_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function merchant_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function merchant_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function merchant_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function merchant_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function merchant_batch_actions(&$args) {
