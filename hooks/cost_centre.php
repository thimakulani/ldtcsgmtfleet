<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'cost_centre' table. 
	...
	*/
	...
	function cost_centre_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function cost_centre_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function cost_centre_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function cost_centre_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function cost_centre_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['cost_centre_id'], $data['cost_centre']
	...
	*/
	...
	function cost_centre_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function cost_centre_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function cost_centre_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function cost_centre_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function cost_centre_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function cost_centre_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function cost_centre_batch_actions(&$args) {
