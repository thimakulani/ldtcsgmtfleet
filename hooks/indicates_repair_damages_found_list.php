<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'indicates_repair_damages_found_list' table. 
	...
	*/
	...
	function indicates_repair_damages_found_list_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function indicates_repair_damages_found_list_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function indicates_repair_damages_found_list_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['brought_in_for_repairs'], $data['after_repairs'], $data['driver_name_and_surname'], $data['driver_persal_number'], $data['driver_signature'], $data['vehicle_return_date_signed'], $data['company_name_and_surname'], $data['company_repesentative_signature'], $data['vehicle_return_date_signed_by_representative'], $data['indicates_and_list_details_of_damages_deficiencies']
	...
	*/
	...
	function indicates_repair_damages_found_list_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function indicates_repair_damages_found_list_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['repair_damages_list_id'], $data['brought_in_for_repairs'], $data['after_repairs'], $data['driver_name_and_surname'], $data['driver_persal_number'], $data['driver_signature'], $data['vehicle_return_date_signed'], $data['company_name_and_surname'], $data['company_repesentative_signature'], $data['vehicle_return_date_signed_by_representative'], $data['indicates_and_list_details_of_damages_deficiencies']
	...
	*/
	...
	function indicates_repair_damages_found_list_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function indicates_repair_damages_found_list_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function indicates_repair_damages_found_list_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function indicates_repair_damages_found_list_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function indicates_repair_damages_found_list_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function indicates_repair_damages_found_list_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function indicates_repair_damages_found_list_batch_actions(&$args) {
