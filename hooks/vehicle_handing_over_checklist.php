<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'vehicle_handing_over_checklist' table. 
	...
	*/
	...
	function vehicle_handing_over_checklist_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_handing_over_checklist_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function vehicle_handing_over_checklist_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['company_name'], $data['company_address'], $data['company_contact_details'], $data['reason_for_handling_over'], $data['name_of_department'], $data['name_of_component'], $data['transport_officer_name_and_surname'], $data['transport_officer_email'], $data['job_pre_authorization_number'], $data['vehicle_registration_number'], $data['closing_km'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['authorization_number'], $data['authorization_date'], $data['radio_dvd_combination'], $data['number_of_keys_handling_over'], $data['jack_with_handle'], $data['tyre_spare'], $data['tyre_spare_condition'], $data['wheel_spanner'], $data['wheel_cups'], $data['tri_angles'], $data['mats'], $data['other'], $data['number_of_keys'], $data['tyre_r_f'], $data['tyre_r_f_1'], $data['tyre_r_f_1_1'], $data['tyre_r_r'], $data['tyre_r_r_1'], $data['tyre_r_r_1_1'], $data['tyre_l_f'], $data['tyre_l_f_1'], $data['tyre_l_f_1_1'], $data['tyer_l_r'], $data['tyer_l_r_1'], $data['tyre_l_r_1_1'], $data['driver_name_and_surname'], $data['driver_persal_number'], $data['driver_signature'], $data['date_checked_in'], $data['testing_officer_name_and_surname'], $data['testing_officer_signature'], $data['fuel_gauge_amount'], $data['vehicle_marks_1'], $data['vehicle_marks_2'], $data['vehicle_marks_3'], $data['vehicle_marks_4'], $data['vehicle_marks_5'], $data['vehicle_marks_6'], $data['vehicle_marks_7'], $data['vehicle_marks_8'], $data['remarks'], $data['vehicle_handing_over_ckecklist']
	...
	*/
	...
	function vehicle_handing_over_checklist_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_handing_over_checklist_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['vehicle_handing_over_id'], $data['company_name'], $data['company_address'], $data['company_contact_details'], $data['reason_for_handling_over'], $data['name_of_department'], $data['name_of_component'], $data['transport_officer_name_and_surname'], $data['transport_officer_email'], $data['job_pre_authorization_number'], $data['vehicle_registration_number'], $data['closing_km'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['authorization_number'], $data['authorization_date'], $data['radio_dvd_combination'], $data['number_of_keys_handling_over'], $data['jack_with_handle'], $data['tyre_spare'], $data['tyre_spare_condition'], $data['wheel_spanner'], $data['wheel_cups'], $data['tri_angles'], $data['mats'], $data['other'], $data['number_of_keys'], $data['tyre_r_f'], $data['tyre_r_f_1'], $data['tyre_r_f_1_1'], $data['tyre_r_r'], $data['tyre_r_r_1'], $data['tyre_r_r_1_1'], $data['tyre_l_f'], $data['tyre_l_f_1'], $data['tyre_l_f_1_1'], $data['tyer_l_r'], $data['tyer_l_r_1'], $data['tyre_l_r_1_1'], $data['driver_name_and_surname'], $data['driver_persal_number'], $data['driver_signature'], $data['date_checked_in'], $data['testing_officer_name_and_surname'], $data['testing_officer_signature'], $data['fuel_gauge_amount'], $data['vehicle_marks_1'], $data['vehicle_marks_2'], $data['vehicle_marks_3'], $data['vehicle_marks_4'], $data['vehicle_marks_5'], $data['vehicle_marks_6'], $data['vehicle_marks_7'], $data['vehicle_marks_8'], $data['remarks'], $data['vehicle_handing_over_ckecklist']
	...
	*/
	...
	function vehicle_handing_over_checklist_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_handing_over_checklist_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_handing_over_checklist_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_handing_over_checklist_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_handing_over_checklist_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function vehicle_handing_over_checklist_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_handing_over_checklist_batch_actions(&$args) {
