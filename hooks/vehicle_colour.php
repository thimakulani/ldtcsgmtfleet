<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'vehicle_colour' table. 
	...
	*/
	...
	function vehicle_colour_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_colour_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function vehicle_colour_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function vehicle_colour_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_colour_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['vehicle_colour_id'], $data['colour_of_vehicle']
	...
	*/
	...
	function vehicle_colour_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_colour_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_colour_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_colour_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_colour_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function vehicle_colour_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_colour_batch_actions(&$args) {
