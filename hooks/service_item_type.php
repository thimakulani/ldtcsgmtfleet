<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'service_item_type' table. 
	...
	*/
	...
	function service_item_type_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_type_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function service_item_type_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['service_item_type'], $data['service_item_type_code']
	...
	*/
	...
	function service_item_type_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_type_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['service_item_type_id'], $data['service_item_type'], $data['service_item_type_code']
	...
	*/
	...
	function service_item_type_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_type_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_type_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_type_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_type_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function service_item_type_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_type_batch_actions(&$args) {
