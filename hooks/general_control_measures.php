<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'general_control_measures' table. 
	...
	*/
	...
	function general_control_measures_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function general_control_measures_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function general_control_measures_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['government_garage_station'], $data['government_garage_name'], $data['government_garage_section'], $data['government_garage_manager_name_and_surname'], $data['government_garage_manager_contact_details'], $data['government_garage_manager_email_address'], $data['government_garage_manager_signature'], $data['government_garage_address'], $data['government_garage_condition'], $data['four_post_lift_condition'], $data['low_level_lift_condition'], $data['test_machines_conditions'], $data['battery_testers_conditions'], $data['chargers_conditions'], $data['tools_conditions'], $data['hand_tools_conditions'], $data['equipment_conditions'], $data['sectional_inspection']
	...
	*/
	...
	function general_control_measures_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function general_control_measures_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['general_control_measures_id'], $data['government_garage_station'], $data['government_garage_name'], $data['government_garage_section'], $data['government_garage_manager_name_and_surname'], $data['government_garage_manager_contact_details'], $data['government_garage_manager_email_address'], $data['government_garage_manager_signature'], $data['government_garage_address'], $data['government_garage_condition'], $data['four_post_lift_condition'], $data['low_level_lift_condition'], $data['test_machines_conditions'], $data['battery_testers_conditions'], $data['chargers_conditions'], $data['tools_conditions'], $data['hand_tools_conditions'], $data['equipment_conditions'], $data['sectional_inspection']
	...
	*/
	...
	function general_control_measures_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function general_control_measures_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function general_control_measures_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function general_control_measures_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function general_control_measures_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function general_control_measures_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function general_control_measures_batch_actions(&$args) {
