<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'service_item' table. 
	...
	*/
	...
	function service_item_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function service_item_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function service_item_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['service_item_id'], $data['service_item']
	...
	*/
	...
	function service_item_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function service_item_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function service_item_batch_actions(&$args) {
