<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'identification_of_defects' table. 
	...
	*/
	...
	function identification_of_defects_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function identification_of_defects_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function identification_of_defects_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['end_user_name_and_surname'], $data['end_user_contact_details'], $data['end_user_persal_number'], $data['end_user_email_address'], $data['end_user_signature'], $data['types_of_defects'], $data['courses_of_defects'], $data['condition_of_defects'], $data['transport_officer_name_and_surname'], $data['transport_officer_persal_number'], $data['transport_officer_contact_details'], $data['transport_officer_email_address'], $data['government_garage_manager_name_and_surname'], $data['government_garage_manager_contact_details'], $data['government_garage_manager_address'], $data['government_garage_manager_email_address'], $data['government_garage_manager_signature']
	...
	*/
	...
	function identification_of_defects_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function identification_of_defects_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['defects_id'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['end_user_name_and_surname'], $data['end_user_contact_details'], $data['end_user_persal_number'], $data['end_user_email_address'], $data['end_user_signature'], $data['types_of_defects'], $data['courses_of_defects'], $data['condition_of_defects'], $data['transport_officer_name_and_surname'], $data['transport_officer_persal_number'], $data['transport_officer_contact_details'], $data['transport_officer_email_address'], $data['government_garage_manager_name_and_surname'], $data['government_garage_manager_contact_details'], $data['government_garage_manager_address'], $data['government_garage_manager_email_address'], $data['government_garage_manager_signature']
	...
	*/
	...
	function identification_of_defects_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function identification_of_defects_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function identification_of_defects_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function identification_of_defects_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function identification_of_defects_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function identification_of_defects_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function identification_of_defects_batch_actions(&$args) {
