<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'log_sheet' table. 
	...
	*/
	...
	function log_sheet_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function log_sheet_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function log_sheet_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['vehicle_registration_number'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['district'], $data['month'], $data['year_model_specification'], $data['drivers_name_and_surname'], $data['drivers_persal_number'], $data['opening_km'], $data['closing_km'], $data['total_km'], $data['engine_capacity'], $data['fuel_type'], $data['fuel_tank_capacity'], $data['vendor'], $data['fuel_cost_litre'], $data['refuel_quantity_1'], $data['refuel_first_time_date'], $data['trip_distance_refuel_1'], $data['refuel_quantity_2'], $data['refuel_second_time_date'], $data['trip_distance_refuel_2'], $data['refuel_quantity_3'], $data['refuel_third_time_date'], $data['trip_distance_refuel_3'], $data['refuel_quantity_4'], $data['refuel_fourth_time_date'], $data['trip_distance_refuel_4'], $data['refuel_quantity_5'], $data['refuel_fifth_time_date'], $data['trip_distance_refuel_5'], $data['refuel_quantity_6'], $data['trip_distance_refuel_6'], $data['refuel_sixth_time_date'], $data['times_refuel_current_month'], $data['total_trip_distance'], $data['total_fuel_quantity'], $data['fuel_consumption'], $data['fuel_total_cost'], $data['payment_e_fuel_card'], $data['captured_by'], $data['comments'], $data['date_captured'], $data['complete_fill_up']
	...
	*/
		...
		function log_sheet_before_insert(&$data, $memberInfo, &$args){

        $ok = $data['opening_km'];


        $tdr1 = $data['trip_distance_refuel_1'];
        $tdr2 = $data['trip_distance_refuel_2'];
        $tdr3 = $data['trip_distance_refuel_3'];
        $tdr4 = $data['trip_distance_refuel_4'];
        $tdr5 = $data['trip_distance_refuel_5'];
        $tdr6 = $data['trip_distance_refuel_6'];


        $tdr = $tdr1 + $tdr2 + $tdr3 + $tdr4 + $tdr5 + $tdr6;
        $data['total_trip_distance'] = $tdr;
        ...
        $data['closing_km'] = $ck;
	 	...
	 	$rfq1 = $data['refuel_quantity_1'];
	 	$rfq2 = $data['refuel_quantity_2'];
	 	$rfq3 = $data['refuel_quantity_3'];
	 	$rfq4 = $data['refuel_quantity_4'];
        $rfq5 = $data['refuel_quantity_5'];
        $rfq6 = $data['refuel_quantity_6'];

		$tfq = $rfq1 + $rfq2 + $rfq3 + $rfq4 + $rfq5 + $rfq6;
		$data['total_fuel_quantity'] = $tfq;

		$fc =  $tdr/$tfq;
	 	$data['fuel_consumption'] = $fc;


		$fcl = $data['fuel_cost_litre'];

		$ftc = $tfq * $fcl;
	 	$data['fuel_total_cost'] = $ftc;
	...
	*/
	...
	function log_sheet_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are:
	 *     $data['fuel_log_sheet_id'], $data['vehicle_registration_number'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['district'], $data['month'], $data['year_model_specification'], $data['drivers_name_and_surname'], $data['drivers_persal_number'], $data['opening_km'], $data['closing_km'], $data['total_km'], $data['engine_capacity'], $data['fuel_type'], $data['fuel_tank_capacity'], $data['vendor'], $data['fuel_cost_litre'], $data['refuel_quantity_1'], $data['refuel_first_time_date'], $data['trip_distance_refuel_1'], $data['refuel_quantity_2'], $data['refuel_second_time_date'], $data['trip_distance_refuel_2'], $data['refuel_quantity_3'], $data['refuel_third_time_date'], $data['trip_distance_refuel_3'], $data['refuel_quantity_4'], $data['refuel_fourth_time_date'], $data['trip_distance_refuel_4'], $data['refuel_quantity_5'], $data['refuel_fifth_time_date'], $data['trip_distance_refuel_5'], $data['refuel_quantity_6'], $data['trip_distance_refuel_6'], $data['refuel_sixth_time_date'], $data['times_refuel_current_month'], $data['total_trip_distance'], $data['total_fuel_quantity'], $data['fuel_consumption'], $data['fuel_total_cost'], $data['payment_e_fuel_card'], $data['captured_by'], $data['comments'], $data['date_captured'], $data['complete_fill_up']
	...
	*/
	...
	function log_sheet_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function log_sheet_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function log_sheet_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function log_sheet_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function log_sheet_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function log_sheet_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function log_sheet_batch_actions(&$args) {
