<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'withdrawal_vehicle_from_operation' table. 
	...
	*/
	...
	function withdrawal_vehicle_from_operation_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function withdrawal_vehicle_from_operation_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function withdrawal_vehicle_from_operation_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['supervisor_name_and_surname'], $data['supervisor_contact_details'], $data['supervisor_email_address'], $data['supervisor_signature'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['purchased_price'], $data['date_of_service'], $data['date_of_next_service'], $data['renewal_of_license'], $data['date_of_vehicle'], $data['description_of_vehicle_breakdown'], $data['tyre_inspection_report'], $data['document_checklist_report'], $data['compiled_technical_report'], $data['district_officer_name_and_surname'], $data['district_officer_persal_number'], $data['district_officer_contacts'], $data['district_officer_signature'], $data['district_officer_email_address']
	...
	*/
	...
	function withdrawal_vehicle_from_operation_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function withdrawal_vehicle_from_operation_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['withdrawal_id'], $data['supervisor_name_and_surname'], $data['supervisor_contact_details'], $data['supervisor_email_address'], $data['supervisor_signature'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['purchased_price'], $data['date_of_service'], $data['date_of_next_service'], $data['renewal_of_license'], $data['date_of_vehicle'], $data['description_of_vehicle_breakdown'], $data['tyre_inspection_report'], $data['document_checklist_report'], $data['compiled_technical_report'], $data['district_officer_name_and_surname'], $data['district_officer_persal_number'], $data['district_officer_contacts'], $data['district_officer_signature'], $data['district_officer_email_address']
	...
	*/
	...
	function withdrawal_vehicle_from_operation_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function withdrawal_vehicle_from_operation_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function withdrawal_vehicle_from_operation_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function withdrawal_vehicle_from_operation_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function withdrawal_vehicle_from_operation_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function withdrawal_vehicle_from_operation_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function withdrawal_vehicle_from_operation_batch_actions(&$args) {
