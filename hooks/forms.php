<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'forms' table. 
	...
	*/
	...
	function forms_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function forms_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function forms_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['government_motor_transport_handbook'], $data['approved_workshop_procedure_manual'], $data['vehicle_daily_check_list_and_appraisal_report'], $data['z181_report_on_accident'], $data['vehicle_handing_over_ckecklist'], $data['vehicle_return_list'], $data['indicates_and_list_details_of_damages_deficiencies']
	...
	*/
	...
	function forms_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function forms_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['forms_id'], $data['government_motor_transport_handbook'], $data['approved_workshop_procedure_manual'], $data['vehicle_daily_check_list_and_appraisal_report'], $data['z181_report_on_accident'], $data['vehicle_handing_over_ckecklist'], $data['vehicle_return_list'], $data['indicates_and_list_details_of_damages_deficiencies']
	...
	*/
	...
	function forms_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function forms_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function forms_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function forms_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function forms_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function forms_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function forms_batch_actions(&$args) {
