<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'driver' table. 
	...
	*/
	...
	function driver_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function driver_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function driver_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['drivers_name_and_surname'], $data['drivers_persal_number'], $data['drivers_contact_details'], $data['drivers_email_address'], $data['drivers_license'], $data['drivers_license_code'], $data['drivers_license_number'], $data['drivers_license_upload'], $data['drivers_license_expire_date'], $data['drivers_license_renewal_date'], $data['drivers_log_history'], $data['drivers_license_penalties'], $data['drivers_license_penalties_date'], $data['drivers_license_penalty_details'], $data['drivers_license_penalty_details_uploads'], $data['involved_in_accident'], $data['accident_report']
	...
	*/
	...
	function driver_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function driver_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['driver_id'], $data['drivers_name_and_surname'], $data['drivers_persal_number'], $data['drivers_contact_details'], $data['drivers_email_address'], $data['drivers_license'], $data['drivers_license_code'], $data['drivers_license_number'], $data['drivers_license_upload'], $data['drivers_license_expire_date'], $data['drivers_license_renewal_date'], $data['drivers_log_history'], $data['drivers_license_penalties'], $data['drivers_license_penalties_date'], $data['drivers_license_penalty_details'], $data['drivers_license_penalty_details_uploads'], $data['involved_in_accident'], $data['accident_report']
	...
	*/
	...
	function driver_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function driver_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function driver_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function driver_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function driver_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function driver_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function driver_batch_actions(&$args) {
