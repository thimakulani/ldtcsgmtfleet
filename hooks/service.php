<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'service' table. 
	...
	*/
	...
	function service_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function service_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function service_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['breakdown_of_vehicle'], $data['service_title'], $data['service_item_type'], $data['service_category'], $data['merchant_name'], $data['vehicle_registration_number'], $data['engine_number'], $data['chassis_number'], $data['dealer_name'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['year_model_of_vehicle'], $data['type_of_vehicle'], $data['closing_km'], $data['application_status'], $data['work_allocation_reference_number'], $data['barcode_number'], $data['department'], $data['service_item'], $data['date_of_service'], $data['time'], $data['upload_quotation'], $data['date_of_next_service'], $data['repeat_service_schedule_every_km'], $data['comments'], $data['upload_invoice'], $data['receptionist'], $data['receptionist_contact_email'], $data['workshop_name'], $data['workshop_address'], $data['technician'], $data['work_order_status'], $data['job_card_number'], $data['completion_date'], $data['due_date'], $data['birth_date']
	...
	*/
	...
	function service_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['breakdown_of_vehicle'], $data['service_title'], $data['service_item_type'], $data['service_category'], $data['merchant_name'], $data['vehicle_registration_number'], $data['engine_number'], $data['chassis_number'], $data['dealer_name'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['year_model_of_vehicle'], $data['type_of_vehicle'], $data['closing_km'], $data['application_status'], $data['work_allocation_reference_number'], $data['barcode_number'], $data['department'], $data['service_item'], $data['date_of_service'], $data['time'], $data['upload_quotation'], $data['date_of_next_service'], $data['repeat_service_schedule_every_km'], $data['comments'], $data['upload_invoice'], $data['receptionist'], $data['receptionist_contact_email'], $data['workshop_name'], $data['workshop_address'], $data['technician'], $data['work_order_status'], $data['job_card_number'], $data['completion_date'], $data['due_date'], $data['birth_date'], $data['age'], $data['filed'], $data['last_modified']
	...
	*/
	...
	function service_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['service_id'], $data['breakdown_of_vehicle'], $data['service_title'], $data['service_item_type'], $data['service_category'], $data['merchant_name'], $data['vehicle_registration_number'], $data['engine_number'], $data['chassis_number'], $data['dealer_name'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['year_model_of_vehicle'], $data['type_of_vehicle'], $data['closing_km'], $data['application_status'], $data['work_allocation_reference_number'], $data['barcode_number'], $data['department'], $data['service_item'], $data['date_of_service'], $data['time'], $data['upload_quotation'], $data['date_of_next_service'], $data['repeat_service_schedule_every_km'], $data['comments'], $data['upload_invoice'], $data['receptionist'], $data['receptionist_contact_email'], $data['workshop_name'], $data['workshop_address'], $data['technician'], $data['work_order_status'], $data['job_card_number'], $data['completion_date'], $data['due_date'], $data['birth_date']
	...
	*/
	...
	function service_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function service_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function service_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function service_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function service_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function service_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function service_batch_actions(&$args) {
