<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'costing' table. 
	...
	*/
	...
	function costing_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function costing_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function costing_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['government_garage_name'], $data['supervisor_name_and_surname'], $data['supervisor_contact_details'], $data['supervisor_email_address'], $data['supervisor_signature'], $data['job_card_number'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['reconciliation_of_total_costs_by_costing_officer'], $data['costing_officer_name_and_surname'], $data['costing_officer_contact_details'], $data['costing_officer_email_address'], $data['costing_officer_signature'], $data['material_cost'], $data['spares_orders_quotation'], $data['spares_orders_quotation_upload'], $data['standard_labour_cost_per_hour'], $data['labour_quotation'], $data['labour_quotation_upload'], $data['vat'], $data['total_amount'], $data['workshop_manager_name_and_surname'], $data['workshop_manager_contact_details'], $data['workshop_manager_email_address'], $data['workshop_manager_signature'], $data['invoice_approved'], $data['upload_invoice']
	...
	*/
	...
	function costing_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function costing_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['costing_id'], $data['government_garage_name'], $data['supervisor_name_and_surname'], $data['supervisor_contact_details'], $data['supervisor_email_address'], $data['supervisor_signature'], $data['job_card_number'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['reconciliation_of_total_costs_by_costing_officer'], $data['costing_officer_name_and_surname'], $data['costing_officer_contact_details'], $data['costing_officer_email_address'], $data['costing_officer_signature'], $data['material_cost'], $data['spares_orders_quotation'], $data['spares_orders_quotation_upload'], $data['standard_labour_cost_per_hour'], $data['labour_quotation'], $data['labour_quotation_upload'], $data['vat'], $data['total_amount'], $data['workshop_manager_name_and_surname'], $data['workshop_manager_contact_details'], $data['workshop_manager_email_address'], $data['workshop_manager_signature'], $data['invoice_approved'], $data['upload_invoice']
	...
	*/
	...
	function costing_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function costing_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function costing_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function costing_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function costing_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function costing_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function costing_batch_actions(&$args) {
