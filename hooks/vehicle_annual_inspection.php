<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'vehicle_annual_inspection' table. 
	...
	*/
	...
	function vehicle_annual_inspection_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_annual_inspection_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function vehicle_annual_inspection_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['vehicle_registration_number'], $data['register_number'], $data['engine_number'], $data['chassis_number'], $data['dealer_name'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['year_model_specification'], $data['engine_capacity'], $data['tyre_size'], $data['transmission'], $data['fuel_type'], $data['type_of_vehicle'], $data['colour_of_vehicle'], $data['application_status'], $data['case_number'], $data['barcode_number'], $data['purchase_price'], $data['depreciation_value'], $data['photo_of_vehicle'], $data['user_name_and_surname'], $data['user_contact_email'], $data['contact_number'], $data['department_name'], $data['department_address'], $data['province'], $data['district'], $data['drivers_name_and_surname'], $data['drivers_persal_number'], $data['department_name_of_driver'], $data['drivers_contact_details'], $data['documents'], $data['date_auctioned'], $data['venue'], $data['comments'], $data['renewal_of_license'], $data['mm_code']
	...
	*/
	...
	function vehicle_annual_inspection_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_annual_inspection_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_annual_inspection_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_annual_inspection_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_annual_inspection_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_annual_inspection_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_annual_inspection_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function vehicle_annual_inspection_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_annual_inspection_batch_actions(&$args) {
