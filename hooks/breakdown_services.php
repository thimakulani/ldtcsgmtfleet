<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'breakdown_services' table. 
	...
	*/
	...
	function breakdown_services_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function breakdown_services_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function breakdown_services_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['breakdown_of_vehicle'], $data['breakdown_during_office_hours'], $data['breakdown_within_or_outside_the_province'], $data['description_of_vehicle_breakdown_notes'], $data['description_of_vehicle_breakdown'], $data['date_of_vehicle_breakdown'], $data['work_allocation_reference_number'], $data['job_card_number'], $data['vehicle_registration_number'], $data['engine_number'], $data['closing_km'], $data['date_of_vehicle_reactivation'], $data['type_of_expenditure'], $data['labour_category'], $data['part_number'], $data['part_name'], $data['part_manufacturer_name'], $data['quantity'], $data['expense_of_item'], $data['labour_category_1'], $data['part_number_1'], $data['part_name_1'], $data['part_manufacturer_name_1'], $data['quantity_1'], $data['expense_of_item_1'], $data['material_cost'], $data['average_worktime_hrs'], $data['standard_labour_cost_per_hour'], $data['labour_charges'], $data['vat'], $data['total_amount'], $data['workshop_name'], $data['work_order_status'], $data['comments'], $data['upload_invoice'], $data['receptionist'], $data['receptionist_contact_email'], $data['date_captured']
	...
	*/
	...
	function breakdown_services_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function breakdown_services_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['breakdown_id'], $data['breakdown_of_vehicle'], $data['breakdown_during_office_hours'], $data['breakdown_within_or_outside_the_province'], $data['description_of_vehicle_breakdown_notes'], $data['description_of_vehicle_breakdown'], $data['date_of_vehicle_breakdown'], $data['work_allocation_reference_number'], $data['job_card_number'], $data['vehicle_registration_number'], $data['engine_number'], $data['closing_km'], $data['date_of_vehicle_reactivation'], $data['type_of_expenditure'], $data['labour_category'], $data['part_number'], $data['part_name'], $data['part_manufacturer_name'], $data['quantity'], $data['expense_of_item'], $data['labour_category_1'], $data['part_number_1'], $data['part_name_1'], $data['part_manufacturer_name_1'], $data['quantity_1'], $data['expense_of_item_1'], $data['material_cost'], $data['average_worktime_hrs'], $data['standard_labour_cost_per_hour'], $data['labour_charges'], $data['vat'], $data['total_amount'], $data['workshop_name'], $data['work_order_status'], $data['comments'], $data['upload_invoice'], $data['receptionist'], $data['receptionist_contact_email'], $data['date_captured']
	...
	*/
	...
	function breakdown_services_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function breakdown_services_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function breakdown_services_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function breakdown_services_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function breakdown_services_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function breakdown_services_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function breakdown_services_batch_actions(&$args) {
