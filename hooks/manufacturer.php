<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'manufacturer' table. 
	...
	*/
	...
	function manufacturer_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function manufacturer_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['manufacturer_type'], $data['manufacturer_name'], $data['contact_person'], $data['contact_details'], $data['contact_email']
	...
	*/
	...
	function manufacturer_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['manufacturer_id'], $data['manufacturer_type'], $data['manufacturer_name'], $data['contact_person'], $data['contact_details'], $data['contact_email']
	...
	*/
	...
	function manufacturer_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function manufacturer_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_batch_actions(&$args) {
