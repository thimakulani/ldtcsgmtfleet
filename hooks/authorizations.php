<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'authorizations' table. 
	...
	*/
	...
	function authorizations_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function authorizations_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function authorizations_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['job_code'], $data['job_status'], $data['job_status_date'], $data['job_status_age'], $data['job_age'], $data['job_category'], $data['job_odometer'], $data['instruction_note'], $data['pre_authorisation_date'], $data['authorisation_date'], $data['vehicle_registration_number'], $data['make_of_vehicle'], $data['client'], $data['province_name'], $data['merchant_code'], $data['merchant_name'], $data['merchant_contact_email'], $data['merchant_street_address'], $data['merchant_suburb'], $data['merchant_city'], $data['merchant_address_code'], $data['merchant_contact_details'], $data['total_claim'], $data['total_authorised'], $data['authorization_number'], $data['last_fuel_transaction_date'], $data['external_repairs']
	...
	*/
	...
	function authorizations_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function authorizations_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['authorize_id'], $data['job_code'], $data['job_status'], $data['job_status_date'], $data['job_status_age'], $data['job_age'], $data['job_category'], $data['job_odometer'], $data['instruction_note'], $data['pre_authorisation_date'], $data['authorisation_date'], $data['vehicle_registration_number'], $data['make_of_vehicle'], $data['client'], $data['province_name'], $data['merchant_code'], $data['merchant_name'], $data['merchant_contact_email'], $data['merchant_street_address'], $data['merchant_suburb'], $data['merchant_city'], $data['merchant_address_code'], $data['merchant_contact_details'], $data['total_claim'], $data['total_authorised'], $data['authorization_number'], $data['last_fuel_transaction_date'], $data['external_repairs']
	...
	*/
	...
	function authorizations_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function authorizations_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function authorizations_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function authorizations_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function authorizations_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function authorizations_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function authorizations_batch_actions(&$args) {
