<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'parts' table. 
	...
	*/
	...
	function parts_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function parts_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function parts_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['part_type'], $data['part_number'], $data['part_name'], $data['description'], $data['manufacturer'], $data['dealer'], $data['measure'], $data['unit_price'], $data['quantity'], $data['freight'], $data['amount'], $data['tax'], $data['total_amount'], $data['discount_price'], $data['net_part_price']
	...
	*/
	...
	function parts_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function parts_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['parts_id'], $data['part_type'], $data['part_number'], $data['part_name'], $data['description'], $data['manufacturer'], $data['dealer'], $data['measure'], $data['unit_price'], $data['quantity'], $data['freight'], $data['amount'], $data['tax'], $data['total_amount'], $data['discount_price'], $data['net_part_price']
	...
	*/
	...
	function parts_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function parts_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function parts_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function parts_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function parts_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function parts_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function parts_batch_actions(&$args){
