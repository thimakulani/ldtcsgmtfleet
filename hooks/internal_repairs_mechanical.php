<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'internal_repairs_mechanical' table. 
	...
	*/
	...
	function internal_repairs_mechanical_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_mechanical_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function internal_repairs_mechanical_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['workshop_name'], $data['artisan_name_and_surname'], $data['artisan_contacts'], $data['artisan_email_address'], $data['artisan_signature'], $data['artisan_note_of_starting_time'], $data['job_card_number'], $data['work_allocation_reference_number'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['pre_repair_inspections'], $data['artisan_dismantling_solution'], $data['spares_order_quotation'], $data['spares_order_description'], $data['artisan_note_of_completion_time'], $data['inspection_bay_lane_number'], $data['inspection_bay_report'], $data['total_labour_time']
	...
	*/
	...
	function internal_repairs_mechanical_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_mechanical_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['internal_mechanical_id'], $data['workshop_name'], $data['artisan_name_and_surname'], $data['artisan_contacts'], $data['artisan_email_address'], $data['artisan_signature'], $data['artisan_note_of_starting_time'], $data['job_card_number'], $data['work_allocation_reference_number'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['pre_repair_inspections'], $data['artisan_dismantling_solution'], $data['spares_order_quotation'], $data['spares_order_description'], $data['artisan_note_of_completion_time'], $data['inspection_bay_lane_number'], $data['inspection_bay_report'], $data['total_labour_time']
	...
	*/
	...
	function internal_repairs_mechanical_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_mechanical_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_mechanical_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_mechanical_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_mechanical_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function internal_repairs_mechanical_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_mechanical_batch_actions(&$args) {
