<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'vehicle_payments' table. 
	...
	*/
	...
	function vehicle_payments_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_payments_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function vehicle_payments_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['vehicle_registration_number'], $data['engine_number'], $data['chassis_number'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['year_model_of_vehicle'], $data['type_of_vehicle'], $data['application_status'], $data['barcode_number'], $data['purchase_price'], $data['depreciation_value'], $data['closing_km'], $data['department'], $data['acquisition_reference'], $data['date_of_acquisition'], $data['odometer_at_acquisition'], $data['merchant_name'], $data['value_at_acquisition'], $data['term'], $data['month_end'], $data['installment_per_month'], $data['payment_amount'], $data['payment_frequency'], $data['interest_rate'], $data['payment_reference'], $data['paid_so_far'], $data['remaining_balance'], $data['depreciation_since_purchase'], $data['actual_resale_value'], $data['warranty_expires_on'], $data['comments'], $data['documents']
	...
	*/
	...
	function vehicle_payments_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_payments_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_payments_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_payments_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_payments_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_payments_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_payments_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function vehicle_payments_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_payments_batch_actions(&$args) {
