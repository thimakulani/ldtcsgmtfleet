<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'application_status' table. 
	...
	*/
	...
	function application_status_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function application_status_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function application_status_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function application_status_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function application_status_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['application_id'], $data['application_status']
	...
	*/
	...
	function application_status_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function application_status_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function application_status_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function application_status_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function application_status_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function application_status_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function application_status_batch_actions(&$args) {
