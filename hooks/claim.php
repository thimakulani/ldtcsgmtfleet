<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'claim' table. 
	...
	*/
	 ...
	 *     $data['claim_code'], $data['claim_status'], $data['claim_category'], $data['cost_centre'], $data['client_identification'], $data['department_name'], $data['district'], $data['province'], $data['merchant_name'], $data['vehicle_registration_number'], $data['closing_km'], $data['pre_authorization_date'], $data['instruction_note'], $data['invoice_date'], $data['upload_invoice'], $data['payment_date'], $data['authorization_number'], $data['clearance_number'], $data['vehicle_collected_date'], $data['total_claimed'], $data['total_authorized']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['claim_id'], $data['claim_code'], $data['claim_status'], $data['claim_category'], $data['cost_centre'], $data['client_identification'], $data['department_name'], $data['district'], $data['province'], $data['merchant_name'], $data['vehicle_registration_number'], $data['closing_km'], $data['pre_authorization_date'], $data['instruction_note'], $data['invoice_date'], $data['upload_invoice'], $data['payment_date'], $data['authorization_number'], $data['clearance_number'], $data['vehicle_collected_date'], $data['total_claimed'], $data['total_authorized']
