<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'vehicle_daily_check_list' table. 
	...
	*/
	...
	function vehicle_daily_check_list_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_daily_check_list_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function vehicle_daily_check_list_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['inspection_certification_number'], $data['vehicle_registration_number'], $data['make_of_vehicle'], $data['closing_km'], $data['dashboard'], $data['seats'], $data['carpets'], $data['wipers'], $data['head_lights'], $data['tail_lights'], $data['brake_lights'], $data['indicators'], $data['windscreen'], $data['windows'], $data['mirrors'], $data['wheels'], $data['hubcaps'], $data['sparewheel'], $data['tools'], $data['engine_oil'], $data['power_steering_oil'], $data['gearbox_oil'], $data['coolant'], $data['brake_oil'], $data['battery'], $data['brakes_front'], $data['brakes_rear'], $data['fuel_level'], $data['vehicle_fluid_leaks'], $data['note'], $data['document_checklist_report'], $data['next_inspection_date'], $data['drivers_surname'], $data['drivers_persal_number']
	...
	*/
	...
	function vehicle_daily_check_list_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_daily_check_list_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['vehicle_daily_check_list_id'], $data['inspection_certification_number'], $data['vehicle_registration_number'], $data['make_of_vehicle'], $data['closing_km'], $data['dashboard'], $data['seats'], $data['carpets'], $data['wipers'], $data['head_lights'], $data['tail_lights'], $data['brake_lights'], $data['indicators'], $data['windscreen'], $data['windows'], $data['mirrors'], $data['wheels'], $data['hubcaps'], $data['sparewheel'], $data['tools'], $data['engine_oil'], $data['power_steering_oil'], $data['gearbox_oil'], $data['coolant'], $data['brake_oil'], $data['battery'], $data['brakes_front'], $data['brakes_rear'], $data['fuel_level'], $data['vehicle_fluid_leaks'], $data['note'], $data['document_checklist_report'], $data['next_inspection_date'], $data['drivers_surname'], $data['drivers_persal_number']
	...
	*/
	...
	function vehicle_daily_check_list_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_daily_check_list_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_daily_check_list_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_daily_check_list_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_daily_check_list_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function vehicle_daily_check_list_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_daily_check_list_batch_actions(&$args) {
