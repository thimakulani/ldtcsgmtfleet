<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'year_model' table. 
	...
	*/
	...
	function year_model_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function year_model_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function year_model_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function year_model_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function year_model_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['year_model_id'], $data['year_model_specification']
	...
	*/
	...
	function year_model_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function year_model_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function year_model_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function year_model_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function year_model_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function year_model_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function year_model_batch_actions(&$args) {
