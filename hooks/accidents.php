<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'accidents' table. 
	...
	*/
	...
	function accidents_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function accidents_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function accidents_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['vehicle_registration_number'], $data['closing_km'], $data['drivers_surname'], $data['drivers_contact_details'], $data['dealer_name'], $data['model_of_vehicle'], $data['date_of_accident'], $data['z181_accident_form'], $data['z181_accident_form_uploaded'], $data['copy_of_trip_authority'], $data['district'], $data['location'], $data['road_or_street'], $data['coordinates'], $data['deaths'], $data['fatal_amount'], $data['injured'], $data['injured_amount'], $data['description_of_accident'], $data['insured'], $data['upload_photos_damaged_vehicle'], $data['copy_of_sketch_plan'], $data['accident_report_driver'], $data['accident_report_supervisior'], $data['claims_report_accident_committee'], $data['insurance_claims_report'], $data['amount_paid'], $data['police_officer'], $data['contact_details'], $data['case_number'], $data['police_report'], $data['accident_report_number']
	...
	*/
	...
	function accidents_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function accidents_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['accident_id'], $data['vehicle_registration_number'], $data['closing_km'], $data['drivers_surname'], $data['drivers_contact_details'], $data['dealer_name'], $data['model_of_vehicle'], $data['date_of_accident'], $data['z181_accident_form'], $data['z181_accident_form_uploaded'], $data['copy_of_trip_authority'], $data['district'], $data['location'], $data['road_or_street'], $data['coordinates'], $data['deaths'], $data['fatal_amount'], $data['injured'], $data['injured_amount'], $data['description_of_accident'], $data['insured'], $data['upload_photos_damaged_vehicle'], $data['copy_of_sketch_plan'], $data['accident_report_driver'], $data['accident_report_supervisior'], $data['claims_report_accident_committee'], $data['insurance_claims_report'], $data['amount_paid'], $data['police_officer'], $data['contact_details'], $data['case_number'], $data['police_report'], $data['accident_report_number']
	...
	*/
	...
	function accidents_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function accidents_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function accidents_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function accidents_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function accidents_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function accidents_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function accidents_batch_actions(&$args) {
