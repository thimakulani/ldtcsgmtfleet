<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'districts' table. 
	...
	*/
	...
	function districts_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function districts_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function districts_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function districts_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function districts_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['district_id'], $data['district'], $data['station']
	...
	*/
	...
	function districts_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function districts_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function districts_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function districts_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function districts_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function districts_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function districts_batch_actions(&$args) {
