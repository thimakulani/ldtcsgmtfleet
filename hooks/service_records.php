<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'service_records' table. 
	...
	*/
	...
	function service_records_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function service_records_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function service_records_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['vehicle'], $data['image_1'], $data['image_2'], $data['image_3'], $data['image_4'], $data['image_5'], $data['document_1'], $data['document_2'], $data['document_3'], $data['document_4'], $data['document_5'], $data['description']
	...
	*/
	...
	function service_records_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function service_records_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['records_id'], $data['vehicle'], $data['image_1'], $data['image_2'], $data['image_3'], $data['image_4'], $data['image_5'], $data['document_1'], $data['document_2'], $data['document_3'], $data['document_4'], $data['document_5'], $data['description']
	...
	*/
	...
	function service_records_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function service_records_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function service_records_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function service_records_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function service_records_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function service_records_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function service_records_batch_actions(&$args) {
