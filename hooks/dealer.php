<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'dealer' table. 
	...
	*/
	...
	function dealer_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function dealer_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function dealer_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['dealer_type'], $data['make_of_vehicle'], $data['dealer_name'], $data['contact_person'], $data['contact_details'], $data['contact_email']
	...
	*/
	...
	function dealer_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function dealer_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['dealer_id'], $data['dealer_type'], $data['make_of_vehicle'], $data['dealer_name'], $data['contact_person'], $data['contact_details'], $data['contact_email']
	...
	*/
	...
	function dealer_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function dealer_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function dealer_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function dealer_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function dealer_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function dealer_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function dealer_batch_actions(&$args) {
