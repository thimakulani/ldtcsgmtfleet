<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'vehicle_history' table. 
	...
	*/
	...
	function vehicle_history_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_history_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function vehicle_history_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['vehicle_registration_number'], $data['engine_number'], $data['purchased_price'], $data['old_registration_number'], $data['new_vehicle_registration_number'], $data['date_of_vehicle_transfer'], $data['comments'], $data['renewal_of_license'], $data['date_of_service'], $data['date_of_next_service'], $data['purchased_order_number'], $data['claim_code'], $data['tyre_inspection_report'], $data['inspection_certification_number'], $data['document_checklist_report'], $data['next_inspection_date'], $data['breakdown_of_vehicle'], $data['date_of_vehicle_breakdown'], $data['description_of_vehicle_breakdown'], $data['closing_km'], $data['date_of_vehicle_reactivation'], $data['total_cost']
	...
	*/
	...
	function vehicle_history_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_history_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['history_id'], $data['vehicle_registration_number'], $data['engine_number'], $data['purchased_price'], $data['old_registration_number'], $data['new_vehicle_registration_number'], $data['date_of_vehicle_transfer'], $data['comments'], $data['renewal_of_license'], $data['date_of_service'], $data['date_of_next_service'], $data['purchased_order_number'], $data['claim_code'], $data['tyre_inspection_report'], $data['inspection_certification_number'], $data['document_checklist_report'], $data['next_inspection_date'], $data['breakdown_of_vehicle'], $data['date_of_vehicle_breakdown'], $data['description_of_vehicle_breakdown'], $data['closing_km'], $data['date_of_vehicle_reactivation'], $data['total_cost']
	...
	*/
	...
	function vehicle_history_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_history_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_history_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_history_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_history_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function vehicle_history_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_history_batch_actions(&$args) {
