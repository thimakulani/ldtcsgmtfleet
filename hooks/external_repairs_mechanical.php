<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'external_repairs_mechanical' table. 
	...
	*/
	...
	function external_repairs_mechanical_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_mechanical_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function external_repairs_mechanical_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['department_inspector_name_and_surname'], $data['department_inspector_persal_number'], $data['department_authorization_quote_note'], $data['department_inspector_signature'], $data['inspection_approval_repair_note'], $data['department_authorization_quote'], $data['service_provider_name'], $data['service_provider_type'], $data['service_provider_contact_details'], $data['service_provider_address'], $data['service_provider_signature'], $data['service_provider_repair_quote_upload'], $data['service_provider_repair_quote'], $data['repair_requirement_note'], $data['merchant_type'], $data['merchant_code'], $data['merchant_name'], $data['merchant_contacts_details'], $data['merchant_email_address'], $data['merchant_signature'], $data['merchant_address'], $data['merchant_address_code'], $data['date_of_vehicle_send'], $data['authorization_number'], $data['instruction_note'], $data['work_allocation_reference_number'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['date_of_vehicle_received'], $data['mechanical_repair_progress_monitor'], $data['mechanical_repair_progress_monitor_quality_of_work_manship'], $data['vehicle_inspection_report'], $data['upload_invoice']
	...
	*/
	...
	function external_repairs_mechanical_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_mechanical_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['external_mechanical_id'], $data['department_inspector_name_and_surname'], $data['department_inspector_persal_number'], $data['department_authorization_quote_note'], $data['department_inspector_signature'], $data['inspection_approval_repair_note'], $data['department_authorization_quote'], $data['service_provider_name'], $data['service_provider_type'], $data['service_provider_contact_details'], $data['service_provider_address'], $data['service_provider_signature'], $data['service_provider_repair_quote_upload'], $data['service_provider_repair_quote'], $data['repair_requirement_note'], $data['merchant_type'], $data['merchant_code'], $data['merchant_name'], $data['merchant_contacts_details'], $data['merchant_email_address'], $data['merchant_signature'], $data['merchant_address'], $data['merchant_address_code'], $data['date_of_vehicle_send'], $data['authorization_number'], $data['instruction_note'], $data['work_allocation_reference_number'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['date_of_vehicle_received'], $data['mechanical_repair_progress_monitor'], $data['mechanical_repair_progress_monitor_quality_of_work_manship'], $data['vehicle_inspection_report'], $data['upload_invoice']
	...
	*/
	...
	function external_repairs_mechanical_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_mechanical_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_mechanical_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_mechanical_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_mechanical_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function external_repairs_mechanical_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function external_repairs_mechanical_batch_actions(&$args) {
