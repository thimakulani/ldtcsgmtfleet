<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'transmission' table. 
	...
	*/
	...
	function transmission_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function transmission_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function transmission_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function transmission_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function transmission_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['transmission_id'], $data['transmission']
	...
	*/
	...
	function transmission_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function transmission_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function transmission_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function transmission_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function transmission_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function transmission_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function transmission_batch_actions(&$args) {
