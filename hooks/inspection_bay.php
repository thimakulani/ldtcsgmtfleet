<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'inspection_bay' table. 
	...
	*/
	...
	function inspection_bay_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function inspection_bay_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function inspection_bay_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['inspection_bay_supervisor_name_and_surname'], $data['supervisor_contact_details'], $data['supervisor_email_address'], $data['supervisor_signature'], $data['date_of_vehicle_entrance'], $data['job_card_number'], $data['vehicle_registration_number'], $data['engine_number'], $data['workshop_name'], $data['work_allocation_reference_number'], $data['make_of_vehicle'], $data['inspection_bay_lane_number'], $data['inspection_bay_condition'], $data['allocation_feedback'], $data['verification_of_defects'], $data['additional_defects'], $data['additional_defects_record'], $data['repair_requirement_note'], $data['repair_requirement_report'], $data['date_of_vehicle_exit']
	...
	*/
	...
	function inspection_bay_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function inspection_bay_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['inspection_bay_id'], $data['inspection_bay_supervisor_name_and_surname'], $data['supervisor_contact_details'], $data['supervisor_email_address'], $data['supervisor_signature'], $data['date_of_vehicle_entrance'], $data['job_card_number'], $data['vehicle_registration_number'], $data['engine_number'], $data['workshop_name'], $data['work_allocation_reference_number'], $data['make_of_vehicle'], $data['inspection_bay_lane_number'], $data['inspection_bay_condition'], $data['allocation_feedback'], $data['verification_of_defects'], $data['additional_defects'], $data['additional_defects_record'], $data['repair_requirement_note'], $data['repair_requirement_report'], $data['date_of_vehicle_exit']
	...
	*/
	...
	function inspection_bay_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function inspection_bay_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function inspection_bay_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function inspection_bay_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function inspection_bay_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function inspection_bay_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function inspection_bay_batch_actions(&$args) {
