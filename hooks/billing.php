<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'billing' table. 
	...
	*/
	...
	function billing_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function billing_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function billing_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['upload_invoice'], $data['job_card_number'], $data['maintenance_file'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle']
	...
	*/
	...
	function billing_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function billing_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['billing_id'], $data['upload_invoice'], $data['job_card_number'], $data['maintenance_file'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle']
	...
	*/
	...
	function billing_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function billing_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function billing_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function billing_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function billing_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function billing_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function billing_batch_actions(&$args) {
