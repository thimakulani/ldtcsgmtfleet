<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'vehicle_return_check_list' table. 
	...
	*/
	...
	function vehicle_return_check_list_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_return_check_list_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function vehicle_return_check_list_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['vehicle_return_date'], $data['job_card_number'], $data['vehicle_registration_number'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['closing_km'], $data['radio_dvd_combination'], $data['number_of_keys_handling_over'], $data['jack_with_handle'], $data['tyre_spare'], $data['tyre_spare_condition'], $data['wheel_spanner'], $data['wheel_cups'], $data['tri_angles'], $data['other'], $data['number_of_keys'], $data['vehicle_washed'], $data['tyre_r_f'], $data['tyre_r_f_1'], $data['tyre_r_f_1_1'], $data['tyre_r_r'], $data['tyre_r_r_1'], $data['tyre_r_r_1_1'], $data['tyre_l_f'], $data['tyre_l_f_1'], $data['tyre_l_f_1_1'], $data['tyer_l_r'], $data['tyer_l_r_1'], $data['tyre_l_r_1_1'], $data['fuel_gauge_amount'], $data['driver_name_and_surname'], $data['driver_persal_number'], $data['driver_signature'], $data['vehicle_return_date_signed'], $data['testing_officer_name_and_surname'], $data['testing_officer_signature'], $data['vehicle_marks_1'], $data['vehicle_marks_2'], $data['vehicle_marks_3'], $data['vehicle_marks_4'], $data['vehicle_marks_5'], $data['vehicle_marks_6'], $data['vehicle_marks_7'], $data['vehicle_marks_8'], $data['remarks'], $data['vehicle_return_list']
	...
	*/
	...
	function vehicle_return_check_list_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_return_check_list_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['vehicle_return_check_list_id'], $data['vehicle_return_date'], $data['job_card_number'], $data['vehicle_registration_number'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['closing_km'], $data['radio_dvd_combination'], $data['number_of_keys_handling_over'], $data['jack_with_handle'], $data['tyre_spare'], $data['tyre_spare_condition'], $data['wheel_spanner'], $data['wheel_cups'], $data['tri_angles'], $data['other'], $data['number_of_keys'], $data['vehicle_washed'], $data['tyre_r_f'], $data['tyre_r_f_1'], $data['tyre_r_f_1_1'], $data['tyre_r_r'], $data['tyre_r_r_1'], $data['tyre_r_r_1_1'], $data['tyre_l_f'], $data['tyre_l_f_1'], $data['tyre_l_f_1_1'], $data['tyer_l_r'], $data['tyer_l_r_1'], $data['tyre_l_r_1_1'], $data['fuel_gauge_amount'], $data['driver_name_and_surname'], $data['driver_persal_number'], $data['driver_signature'], $data['vehicle_return_date_signed'], $data['testing_officer_name_and_surname'], $data['testing_officer_signature'], $data['vehicle_marks_1'], $data['vehicle_marks_2'], $data['vehicle_marks_3'], $data['vehicle_marks_4'], $data['vehicle_marks_5'], $data['vehicle_marks_6'], $data['vehicle_marks_7'], $data['vehicle_marks_8'], $data['remarks'], $data['vehicle_return_list']
	...
	*/
	...
	function vehicle_return_check_list_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_return_check_list_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_return_check_list_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_return_check_list_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_return_check_list_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function vehicle_return_check_list_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function vehicle_return_check_list_batch_actions(&$args) {
