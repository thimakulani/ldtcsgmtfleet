<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'work_allocation' table. 
	...
	*/
	...
	function work_allocation_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function work_allocation_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function work_allocation_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['workshop_name'], $data['supervisor_name_and_surname'], $data['supervisor_contact_details'], $data['supervisor_email_address'], $data['supervisor_signature'], $data['economical_repair'], $data['uneconomical_repair'], $data['work_allocation_reference_number'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['date_captured']
	...
	*/
	...
	function work_allocation_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function work_allocation_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['work_allocation_id'], $data['workshop_name'], $data['supervisor_name_and_surname'], $data['supervisor_contact_details'], $data['supervisor_email_address'], $data['supervisor_signature'], $data['economical_repair'], $data['uneconomical_repair'], $data['work_allocation_reference_number'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['date_captured']
	...
	*/
	...
	function work_allocation_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function work_allocation_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function work_allocation_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function work_allocation_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function work_allocation_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function work_allocation_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function work_allocation_batch_actions(&$args) {
