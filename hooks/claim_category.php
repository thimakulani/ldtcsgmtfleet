<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'claim_category' table. 
	...
	*/
	...
	function claim_category_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function claim_category_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function claim_category_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function claim_category_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function claim_category_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['claim_category_id'], $data['claim_category']
	...
	*/
	...
	function claim_category_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function claim_category_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function claim_category_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function claim_category_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function claim_category_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function claim_category_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function claim_category_batch_actions(&$args) {
