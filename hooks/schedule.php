<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'schedule' table. 
	...
	*/
	...
	function schedule_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function schedule_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function schedule_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['title'], $data['user_name_and_surname'], $data['user_contact_email'], $data['service_item_type'], $data['service_item_type_code'], $data['application_status'], $data['vehicle_registration_number'], $data['engine_number'], $data['closing_km'], $data['date'], $data['time'], $data['workshop_name'], $data['diagnosis'], $data['prescription'], $data['comments']
	...
	*/
	...
	function schedule_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function schedule_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['schedule_id'], $data['title'], $data['user_name_and_surname'], $data['user_contact_email'], $data['service_item_type'], $data['service_item_type_code'], $data['application_status'], $data['vehicle_registration_number'], $data['engine_number'], $data['closing_km'], $data['date'], $data['time'], $data['workshop_name'], $data['diagnosis'], $data['prescription'], $data['comments']
	...
	*/
	...
	function schedule_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function schedule_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function schedule_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function schedule_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function schedule_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function schedule_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function schedule_batch_actions(&$args) {
