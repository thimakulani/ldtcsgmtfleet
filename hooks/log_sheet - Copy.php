<?php
	...
	*/
	 ...
	 *     $data['vehicle_registration_number'], $data['make_of_vehicle'], $data['model_of_vehicle'], $data['district'], $data['month'], $data['year_model_specification'], $data['year_model'], $data['drivers_surname'], $data['drivers_persal_number'], $data['opening_km'], $data['closing_km'], $data['total_km'], $data['engine_capacity'], $data['fuel_type'], $data['fuel_tank_capacity'], $data['vendor'], $data['fuel_cost_litre'], $data['refuel_quantity_1'], $data['refuel_first_time_date'], $data['refuel_quantity_2'], $data['refuel_second_time_date'], $data['refuel_quantity_3'], $data['refuel_third_time_date'], $data['refuel_quantity_4'], $data['refuel_fourth_time_date'], $data['times_refuel_current_month'], $data['total_fuel_quantity'], $data['fuel_consumption'], $data['fuel_total_cost'], $data['payment_e_fuel_card'], $data['captured_by'], $data['comments'], $data['date_captured'], $data['complete_fill_up']
