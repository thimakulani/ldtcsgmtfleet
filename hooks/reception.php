<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'reception' table. 
	...
	*/
	...
	function reception_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function reception_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function reception_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['reception_name_and_surname'], $data['reception_persal_number'], $data['reception_contact_details'], $data['reception_email_address'], $data['reception_signature'], $data['date_of_vehicle_entrance'], $data['service_status'], $data['workshop_name'], $data['workshop_address'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['breakdown_of_vehicle'], $data['description_of_vehicle_report'], $data['upload_of_vehicle_report'], $data['description_of_vehicle_breakdown'], $data['job_card_number'], $data['visual_inspection_form'], $data['damage_report'], $data['date_of_vehicle_exit'], $data['payment']
	...
	*/
	...
	function reception_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function reception_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['reception_user_id'], $data['reception_name_and_surname'], $data['reception_persal_number'], $data['reception_contact_details'], $data['reception_email_address'], $data['reception_signature'], $data['date_of_vehicle_entrance'], $data['service_status'], $data['workshop_name'], $data['workshop_address'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['breakdown_of_vehicle'], $data['description_of_vehicle_report'], $data['upload_of_vehicle_report'], $data['description_of_vehicle_breakdown'], $data['job_card_number'], $data['visual_inspection_form'], $data['damage_report'], $data['date_of_vehicle_exit'], $data['payment']
	...
	*/
	...
	function reception_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function reception_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function reception_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function reception_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function reception_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function reception_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function reception_batch_actions(&$args) {
