<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'service_categories' table. 
	...
	*/
	...
	function service_categories_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function service_categories_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function service_categories_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function service_categories_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function service_categories_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['service_categories_id'], $data['service_category']
	...
	*/
	...
	function service_categories_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function service_categories_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function service_categories_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function service_categories_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function service_categories_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function service_categories_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function service_categories_batch_actions(&$args) {
