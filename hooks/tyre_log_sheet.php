<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tyre_log_sheet' table. 
	...
	*/
	...
	function tyre_log_sheet_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tyre_log_sheet_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tyre_log_sheet_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['vehicle_registration_number'], $data['tyre_position'], $data['tyre_tread_condition'], $data['tyre_brand'], $data['tyre_model'], $data['tyre_size'], $data['tyre_pressure'], $data['action'], $data['warranty'], $data['documents'], $data['tyre_tread'], $data['tyre_maximum_wear'], $data['inspection_date'], $data['tyre_inspection_done_by'], $data['tyre_inspection_report'], $data['status'], $data['opening_km'], $data['closing_km'], $data['total_km'], $data['comments'], $data['tyres_cause_of_accident'], $data['accident_report'], $data['claims_report'], $data['insurance_claims_report'], $data['reminder_maximum_wear']
	...
	*/
	...
	function tyre_log_sheet_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tyre_log_sheet_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['tyre_log_id'], $data['vehicle_registration_number'], $data['tyre_position'], $data['tyre_tread_condition'], $data['tyre_brand'], $data['tyre_model'], $data['tyre_size'], $data['tyre_pressure'], $data['action'], $data['warranty'], $data['documents'], $data['tyre_tread'], $data['tyre_maximum_wear'], $data['inspection_date'], $data['tyre_inspection_done_by'], $data['tyre_inspection_report'], $data['status'], $data['opening_km'], $data['closing_km'], $data['total_km'], $data['comments'], $data['tyres_cause_of_accident'], $data['accident_report'], $data['claims_report'], $data['insurance_claims_report'], $data['reminder_maximum_wear']
	...
	*/
	...
	function tyre_log_sheet_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tyre_log_sheet_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tyre_log_sheet_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tyre_log_sheet_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tyre_log_sheet_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tyre_log_sheet_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tyre_log_sheet_batch_actions(&$args) {
