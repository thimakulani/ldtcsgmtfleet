<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'auditor' table. 
	...
	*/
	...
	function auditor_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function auditor_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function auditor_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['res_id'], $data['username'], $data['ipaddr'], $data['time_stmp'], $data['change_type'], $data['table_name'], $data['fieldName'], $data['OldValue'], $data['NewValue']
	...
	*/
	...
	function auditor_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function auditor_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['auditor_id'], $data['res_id'], $data['username'], $data['ipaddr'], $data['time_stmp'], $data['change_type'], $data['table_name'], $data['fieldName'], $data['OldValue'], $data['NewValue']
	...
	*/
	...
	function auditor_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function auditor_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function auditor_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function auditor_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function auditor_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function auditor_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function auditor_batch_actions(&$args) {
