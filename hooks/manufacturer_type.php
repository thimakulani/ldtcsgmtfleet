<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'manufacturer_type' table. 
	...
	*/
	...
	function manufacturer_type_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_type_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function manufacturer_type_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function manufacturer_type_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_type_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['manufacturer_type_id'], $data['manufacturer_type']
	...
	*/
	...
	function manufacturer_type_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_type_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_type_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_type_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_type_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function manufacturer_type_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function manufacturer_type_batch_actions(&$args) {
