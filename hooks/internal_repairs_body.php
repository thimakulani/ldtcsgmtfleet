<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'internal_repairs_body' table. 
	...
	*/
	...
	function internal_repairs_body_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_body_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function internal_repairs_body_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['driver_name_and_surname'], $data['driver_persal_number'], $data['driver_contacts_details'], $data['driver_email_address'], $data['driver_license_code'], $data['driver_license_number'], $data['driver_license_upload'], $data['driver_signature'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['z181_accident_form'], $data['z181_accident_form_uploaded'], $data['job_card_number'], $data['work_allocation_reference_number'], $data['artisan_note_of_starting_time'], $data['government_garage_name'], $data['government_garage_contact_details'], $data['government_garage_address'], $data['government_garage_email_address'], $data['damages_occured'], $data['upload_of_internal_damages_1'], $data['upload_of_internal_damages_2'], $data['upload_of_internal_damages_3'], $data['upload_of_internal_damages_4'], $data['head_panel_beating_quotation'], $data['head_panel_beating_quotation_1'], $data['head_panel_beating_name'], $data['head_panel_beating_contact_details'], $data['head_panel_beating_address'], $data['head_panel_beating_signature'], $data['private_panel_beating_name'], $data['private_panel_beating_contact_details'], $data['private_panel_beating_address'], $data['private_panel_beating_quotation'], $data['private_panel_beating_quotation_2'], $data['artisan_note_of_completion_time'], $data['total_labour_time']
	...
	*/
	...
	function internal_repairs_body_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_body_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['internal_repairs_body_id'], $data['driver_name_and_surname'], $data['driver_persal_number'], $data['driver_contacts_details'], $data['driver_email_address'], $data['driver_license_code'], $data['driver_license_number'], $data['driver_license_upload'], $data['driver_signature'], $data['vehicle_registration_number'], $data['engine_number'], $data['make_of_vehicle'], $data['z181_accident_form'], $data['z181_accident_form_uploaded'], $data['job_card_number'], $data['work_allocation_reference_number'], $data['artisan_note_of_starting_time'], $data['government_garage_name'], $data['government_garage_contact_details'], $data['government_garage_address'], $data['government_garage_email_address'], $data['damages_occured'], $data['upload_of_internal_damages_1'], $data['upload_of_internal_damages_2'], $data['upload_of_internal_damages_3'], $data['upload_of_internal_damages_4'], $data['head_panel_beating_quotation'], $data['head_panel_beating_quotation_1'], $data['head_panel_beating_name'], $data['head_panel_beating_contact_details'], $data['head_panel_beating_address'], $data['head_panel_beating_signature'], $data['private_panel_beating_name'], $data['private_panel_beating_contact_details'], $data['private_panel_beating_address'], $data['private_panel_beating_quotation'], $data['private_panel_beating_quotation_2'], $data['artisan_note_of_completion_time'], $data['total_labour_time']
	...
	*/
	...
	function internal_repairs_body_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_body_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_body_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_body_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_body_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function internal_repairs_body_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function internal_repairs_body_batch_actions(&$args) {
