...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$table_perms = getTablePermissions('accidents');
	...
	switch($mfk) {
		...
		case 'vehicle_registration_number':
			if(!$id) {
				?>
				$j('#dealer_name<?php echo $rnd1; ?>').html('&nbsp;');
			...
			?>
			$j('#dealer_name<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['make_of_vehicle']))); ?>&nbsp;');
