...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$table_perms = getTablePermissions('claim');
	...
	switch($mfk) {
		...
		case 'vehicle_registration_number':
			...
			?>
			$j('#model<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(["\r", "\n"], '', safe_html($row['model_of_vehicle'].' |   and    |    '.$row['vehicle_registration_number']))); ?>&nbsp;');
			<?php
			break;
